        ...
        try:
            with connection.cursor() as cursor:
                ...
                test_queries = [
                    (
                        "People Dropdown",
                        "SELECT id, text FROM mv_people_dropdown LIMIT 50;",
                    ),
                    (
                        "Location Dropdown",
                        "SELECT id, text FROM mv_location_dropdown LIMIT 50;",
                    ),
                    (
                        "Asset Dropdown",
                        "SELECT id, text, location_name FROM mv_asset_dropdown LIMIT 50;",
                    ),
                ]
                ...
                print(
                    f"   📊 Complex JOIN query: {complex_time:.2f}ms ({len(complex_results)} records)"
                )
