...
import apps.journal.models.media
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        upload_to=apps.journal.models.media.upload_journal_media,
                    ),
                ),
                (
                    "original_filename",
                    models.CharField(
                        help_text="Original filename from client", max_length=255
                    ),
                ),
                (
                    "mime_type",
                ...
                (
                    "caption",
                    models.TextField(
                        blank=True, help_text="Optional caption for the media"
                    ),
                ),
                (
                    "display_order",
                    models.IntegerField(
                        default=0, help_text="Order for displaying multiple media items"
                    ),
                ),
                (
                    "is_hero_image",
                ...
                (
                    "mobile_id",
                    models.UUIDField(
                        blank=True, help_text="Client-generated ID for sync", null=True
                    ),
                ),
                (
                    "sync_status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("manager", "Manager - Visible to my direct manager"),
                            ("team", "Team - Visible to my team"),
                            ("aggregate", "Aggregate - Anonymous statistics only"),
                            ("shared", "Shared - Visible to selected stakeholders"),
                        ],
                        default="private",
                ...
                (
                    "consent_timestamp",
                    models.DateTimeField(help_text="When initial consent was given"),
                ),
                ("updated_at", models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("three_good_things", "3 Good Things"),
                ...
                (
                    "subtitle",
                    models.CharField(
                        blank=True, help_text="Optional subtitle", max_length=200
                    ),
                ),
                (
                    "content",
                    models.TextField(blank=True, help_text="Main entry content"),
                ),
                (
                    "timestamp",
                    models.DateTimeField(help_text="When this entry was created"),
                ),
                (
                    "duration_minutes",
                    models.IntegerField(
                ...
                (
                    "consent_given",
                    models.BooleanField(
                        default=False, help_text="User consent for data processing"
                    ),
                ),
                (
                    "consent_timestamp",
                ...
                (
                    "stress_triggers",
                    models.JSONField(
                        default=list, help_text="List of identified stress triggers"
                    ),
                ),
                (
                    "coping_strategies",
                    models.JSONField(
                        default=list, help_text="List of coping strategies used"
                    ),
                ),
                (
                    "gratitude_items",
                    models.JSONField(
                        default=list, help_text="List of things user is grateful for"
                    ),
                ),
                (
                    "daily_goals",
                    models.JSONField(
                        default=list, help_text="List of daily goals or intentions"
                    ),
                ),
                (
                    "affirmations",
                    models.JSONField(
                        default=list, help_text="List of positive affirmations"
                    ),
                ),
                (
                    "achievements",
                ...
                (
                    "learnings",
                    models.JSONField(
                        default=list, help_text="List of key learnings from the day"
                    ),
                ),
                (
                    "challenges",
                    models.JSONField(
                        default=list, help_text="List of challenges faced"
                    ),
                ),
                (
                    "location_site_name",
                ...
                (
                    "location_address",
                    models.TextField(blank=True, help_text="Full address of location"),
                ),
                (
                ...
                (
                    "team_members",
                    models.JSONField(
                        default=list, help_text="List of team members involved"
                    ),
                ),
                (
                    "tags",
                ...
                (
                    "is_bookmarked",
                    models.BooleanField(
                        default=False, help_text="Whether entry is bookmarked by user"
                    ),
                ),
                (
                    "is_draft",
                    models.BooleanField(
                        default=False, help_text="Whether entry is still a draft"
                    ),
                ),
                (
                    "is_deleted",
