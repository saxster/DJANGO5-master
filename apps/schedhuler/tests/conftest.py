...
def sample_people():
    return People.objects.create(
        peoplename="Test Person", peopleemail="test@example.com", peoplecode="TEST001"
    )


@pytest.fixture
def sample_group():
    return Pgroup.objects.create(groupname="Test Group")


@pytest.fixture
def sample_bt():
    return Bt.objects.create(buname="Test BU", buadd="Test Address")


@pytest.fixture
def sample_asset():
    return Asset.objects.create(
        assetname="Test Asset", assetdesc="Test Asset Description"
    )


@pytest.fixture
def sample_questionset():
    return QuestionSet.objects.create(qsetname="Test Questionset")
