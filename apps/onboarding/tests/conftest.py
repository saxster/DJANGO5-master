...
def test_root_client():
    ...
    return Bt.objects.create(
        bucode="ROOTCLIENT", buname="Root Test Client", enable=True
    )
...
def test_client_bt():
    ...
    return Bt.objects.create(
        bucode="TESTCLIENT", buname="Test Client Organization", enable=True
    )
...
def test_bu_bt(test_client_bt):
    ...
    return Bt.objects.create(
        bucode="TESTBU", buname="Test Business Unit", parent=test_client_bt, enable=True
    )
...
def test_identifier_client():
    ...
    return TypeAssist.objects.create(tacode="CLIENT", taname="Client", enable=True)


@pytest.fixture
def test_identifier_site():
    """Create SITE identifier TypeAssist"""
    return TypeAssist.objects.create(tacode="SITE", taname="Site", enable=True)
...
def test_bu_type():
    ...
    return TypeAssist.objects.create(
        tacode="BUTYPE", taname="Business Unit Type", enable=True
    )
...
def test_designation_type():
    ...
    return TypeAssist.objects.create(
        tacode="SECURITY_GUARD", taname="Security Guard", enable=True
    )
...
def bt_factory():
    ...
    def _create_bt(bucode=None, buname=None, parent=None, identifier=None, **kwargs):
        defaults = {
...
def typeassist_factory():
    ...
    def _create_typeassist(
        tacode=None, taname=None, tatype=None, client=None, bu=None, **kwargs
    ):
        defaults = {
...
def shift_factory(test_client_bt, test_bu_bt):
    ...
    def _create_shift(shiftname=None, client=None, bu=None, designation=None, **kwargs):
        defaults = {
...
def geofence_factory(test_client_bt, test_bu_bt):
    ...
    def _create_geofence(gfcode=None, gfname=None, client=None, bu=None, **kwargs):
...
def device_factory(test_client_bt):
    ...
    def _create_device(handsetname=None, client=None, **kwargs):
        defaults = {
...
def subscription_factory(test_client_bt):
    ...
    def _create_subscription(client=None, assignedhandset=None, **kwargs):
        defaults = {
...
@pytest.fixture
def authenticated_onboarding_request(
    rf, test_people_onboarding, test_client_bt, test_bu_bt
):
