...
class TestLoginForm:
    ...
    def test_login_form_valid_data(self, people_factory, test_password):
        ...
        user = people_factory(loginid="testuser", isverified=True, enable=True)
...
class TestPeopleForm:
    ...
    def test_people_form_valid_data(
        self,
        authenticated_request,
        test_client_bt,
        test_bu_bt,
        test_typeassist_department,
        test_typeassist_designation,
    ):
    ...
    def test_people_form_email_validation(
        self, authenticated_request, test_client_bt, test_bu_bt
    ):
    ...
    def test_people_form_gender_choices(self, authenticated_request):
        ...
        if "gender" in form.fields:
            ...
            if hasattr(gender_field, "choices"):
                choice_values = [
                    choice[0] for choice in gender_field.choices if choice[0]
                ]
                assert (
                    "M" in choice_values or "F" in choice_values
                )  # At least some gender options
...
class TestFormIntegration:
    ...
    def test_people_form_model_save(
        self,
        authenticated_request,
        test_client_bt,
        test_bu_bt,
