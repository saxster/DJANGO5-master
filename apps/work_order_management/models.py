    ...
    class Meta(BaseModel.Meta):
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["qset", "client", "id"], name="qset_client"
            ),
        ]
...
class Vendor(BaseModel, TenantAwareModel):
    ...
    class Meta(BaseModel.Meta):
        ...
        constraints = [
            models.UniqueConstraint(fields=["code", "client"], name="code_client"),
        ]
...
class WomDetails(BaseModel, TenantAwareModel):
    ...
    class Meta(BaseModel.Meta):
        ...
        constraints = [
            models.UniqueConstraint(fields=["question", "wom"], name="question_client")
        ]
