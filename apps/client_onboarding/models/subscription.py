"""
Client Infrastructure Models - Device and Subscription Management.

This module contains models for managing client-related infrastructure:
- Device lifecycle management with communication tracking
- Subscription management with status tracking

Extracted from apps.onboarding.models.infrastructure as part of
bounded contexts refactoring.
