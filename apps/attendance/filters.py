...
class AttendanceFilter(django_filters.FilterSet):
    ...
    verifiedby = django_filters.CharFilter(
        field_name="verifiedby__peoplename",
        label="Verified By",
        lookup_expr="icontains",
        widget=forms.TextInput(attrs={"id": "verifiedby"}),
    )
