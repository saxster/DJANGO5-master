...
class TestSessionManagement:
    ...
    def test_session_cleanup_integration(self, mock_session_objects):
        ...
        mock_session_objects.filter.return_value.delete.return_value = (
            10,
            {"sessions.Session": 10},
        )
...
class TestErrorHandling:
    ...
    def test_logging_error_scenarios(self, mock_logger):
        ...
        mock_logger.error.assert_called_with(
            "Test error occurred: Test error for logging"
        )
        ...
        def handle_restricted_deletion():
            try:
                ...
                raise RestrictedError(
                    "Cannot delete due to foreign key constraint", set()
                )
...
class TestJSONHandling:
    ...
    def test_json_encoder_available(self):
        ...
        encoder = JSONEncoder()
        test_data = {"test": True, "timestamp": timezone.now(), "count": 42}
