...
from apps.core_onboarding.services.llm import get_llm_service, get_checker_service
...
from apps.core_onboarding.services.circuit_breaker import get_circuit_breaker
...
from apps.core_onboarding.background_tasks.dead_letter_queue import dlq_handler
...
def apply_approved_recommendations(self, approved_items: list, user_id: int, dry_run: bool = True):
    ...
    try:
        from apps.core_onboarding.integration.mapper import IntegrationAdapter
