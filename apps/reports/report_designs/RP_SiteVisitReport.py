...
class RP_SITEVISITREPORT(BaseReportsExport):
    ...
    def set_context_data(self):
        ...
        self.context = {
            ...
            "data": ReportQueryRepository.rp_sitevisitreport_report(
    ...
    def set_extra_data(self):
        ...
        Data2 = [
            {site: [{str(day): time[0]} for day, time in times.items()]}
            for site, times in formatted_data.items()
        ]
        return Data2
