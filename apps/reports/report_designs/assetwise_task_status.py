...
class AssetwiseTaskStatus(BaseReportsExport):
    ...
    def set_context_data(self):
        ...
        self.context = {
            ...
            "data": ReportQueryRepository.assetwisetaskstatus_report(
    ...
    def set_data(self):
        ...
        self.data = ReportQueryRepository.assetwisetaskstatus_report(
            timezone_str=self.args["timezone"],
            siteids=self.args["siteids"],
            from_date=self.formdata["fromdatetime"],
            upto_date=self.formdata["uptodatetime"]
    ...
    def excel_columns(self, df):
        df = df[["id", "Asset Name", "AutoClosed", "Completed", "Total Tasks"]]
        return df
