...
class DynamicDetailedTourSummaryReport(BaseReportsExport):
    ...
    def set_context_data(self):
        ...
        self.context = {
            ...
            "data": ReportQueryRepository.dynamicdetailedtoursummary_report(
                timezone_str=self.args["timezone"],
                siteids=self.args["siteids"],
    ...
    def set_data(self):
        ...
        """
        self.set_args_required_for_query()
        self.data = ReportQueryRepository.dynamicdetailedtoursummary_report(
            timezone_str=self.args["timezone"],
            siteids=self.args["siteids"],
            from_date=self.formdata["fromdatetime"],
            upto_date=self.formdata["uptodatetime"]
    ...
    def excel_layout(self, worksheet, workbook, df, writer, output):
        ...
        df = df.rename(
            columns={
                ...
                "Site Name": "Site",
                "Description": "Tour",
                "Start Time": "Planned Date Time",
                "End Time": "Expiry Date Time",
                "No of Checkpoints": "Checkpoints",
                "Completed": "Completed",
                "Missed": "Missed",
