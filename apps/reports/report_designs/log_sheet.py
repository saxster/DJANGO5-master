...
class LogSheet(BaseReportsExport):
    ...
    def set_context_data(self):
        ...
        self.context = {
            ...
            "data": ReportQueryRepository.logsheet_report(
                timezone_str=self.args["timezone"],
                buid=self.args["buid"],
                qsetid=self.args["qsetid"],
                assetid=self.args["assetid"]
            ),
    ...
    def set_data(self):
        ...
        self.data = ReportQueryRepository.logsheet_report(
            timezone_str=self.args["timezone"],
            buid=self.args["buid"],
            qsetid=self.args["qsetid"],
            assetid=self.args["assetid"]
