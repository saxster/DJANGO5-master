...
class DynamicTourList(BaseReportsExport):
    report_title = "Dynamic Tour List"
    design_file = "reports/pdf_reports/dynamic_tour_list.html"
    ytpl_applogo = "frontend/static/assets/media/images/logo.png"
    report_name = "DYNAMICTOURLIST"
    ...
    def set_context_data(self):
        ...
        self.context = {
            ...
            "data": ReportQueryRepository.dynamictourlist_report(
    ...
    def set_data(self):
        ...
        self.data = ReportQueryRepository.dynamictourlist_report(
            timezone_str=self.args["timezone"],
            siteids=self.args["siteids"],
            from_date=self.formdata["fromdatetime"],
            upto_date=self.formdata["uptodatetime"]
