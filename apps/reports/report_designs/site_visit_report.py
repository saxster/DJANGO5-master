...
class SiteVisitReport(BaseReportsExport):
    report_title = "Site Visit Report"
    design_file = "reports/pdf_reports/site_visit_report.html"
    ytpl_applogo = "frontend/static/assets/media/images/logo.png"
    report_name = "SITEVISITREPORT"
    ...
    def set_context_data(self):
        ...
        self.context = {
            ...
            "data": ReportQueryRepository.sitevisitreport_report(
                timezone_str=self.args[0],
                siteids=str(self.args[1]),
                date_filter=self.args[2]
            ),
    ...
    def set_data(self):
        ...
        self.data = ReportQueryRepository.sitevisitreport_report(
            timezone_str=self.args[0],
            siteids=str(self.args[1]),
            date_filter=self.args[2]
        )
    ...
    def excel_columns(self, df):
        df = df[["Sr.No", "Question Set", "Question", "Answer"]]
        return df
