            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=apps.reports.models.now, verbose_name="cdtz"
                    ),
                ),
                (
                    "mdtz",
                    models.DateTimeField(
                        default=apps.reports.models.now, verbose_name="mdtz"
                    ),
                ),
                (
                    "has_data",
                    models.BooleanField(
                        default=True, verbose_name="Has Data in Report"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company",
                    models.CharField(
                        choices=[("SPS", "SPS"), ("SFS", "SFS"), ("TARGET", "TARGET")],
                        max_length=60,
                        null=True,
                ...
                (
                    "additional_filter",
                    models.CharField(
                        choices=[("CUSTOMER", "Customer"), ("SITE", "Site")],
                        max_length=60,
                        verbose_name="Additional Filter",
                    ),
                ),
                (
                    "customer",
            ...
            options={
                ...
                "abstract": False,
                "indexes": [
                    models.Index(fields=["mdtz"], name="generatepdf_mdtz_idx"),
                    models.Index(fields=["cdtz"], name="generatepdf_cdtz_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "report_name",
                    models.CharField(max_length=55, verbose_name="Report Name"),
                ),
                (
                    "workingdays",
                    models.CharField(
                        blank=True,
                        choices=[("5", "Monday - Friday"), ("6", "Monday - Saturday")],
                        max_length=1,
                        null=True,
                ...
                (
                    "cron",
                    models.CharField(
                        default="* * * * *", max_length=50, verbose_name="Scheduler"
                    ),
                ),
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.CharField(
                            blank=True, max_length=90, null=True
                        ),
                        blank=True,
                        null=True,
                        size=None,
                ...
                (
                    "crontype",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="Cron Type"
                    ),
                ),
                (
                    "fromdatetime",
                    models.DateTimeField(null=True, verbose_name="Last Generated On"),
                ),
                (
                    "uptodatetime",
                    models.DateTimeField(null=True, verbose_name="Next Scheduled On"),
                ),
                (
                    "lastgeneratedon",
                    models.DateTimeField(null=True, verbose_name="Last Generated On"),
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=apps.reports.models.report_params_json,
                        null=True,
                    ),
                ),
                (
            ...
            options={
                ...
                "abstract": False,
                "indexes": [
                    models.Index(fields=["mdtz"], name="schedulereport_mdtz_idx"),
                    models.Index(fields=["cdtz"], name="schedulereport_cdtz_idx"),
                ],
                "constraints": [
