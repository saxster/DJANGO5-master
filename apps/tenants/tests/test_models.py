...
class TenantModelTest(TestCase):
    def setUp(self):
        ...
        self.tenant_data = {"tenantname": "Test Tenant", "subdomain_prefix": "test"}
    ...
    def test_tenant_fields_max_length(self):
        ...
        tenant = Tenant(tenantname=long_tenantname, subdomain_prefix="test")
    ...
    def test_tenant_subdomain_prefix_max_length(self):
        ...
        tenant = Tenant(tenantname="Test Tenant", subdomain_prefix=long_subdomain)
    ...
    def test_tenant_empty_tenantname(self):
        tenant = Tenant(tenantname="", subdomain_prefix="test")
    ...
    def test_tenant_empty_subdomain_prefix(self):
        tenant = Tenant(tenantname="Test Tenant", subdomain_prefix="")
    ...
    def test_multiple_tenants_creation(self):
        tenant1 = Tenant.objects.create(tenantname="Tenant One", subdomain_prefix="one")
        tenant2 = Tenant.objects.create(tenantname="Tenant Two", subdomain_prefix="two")
...
class TenantAwareModelTest(TestCase):
    def setUp(self):
        ...
        self.tenant = Tenant.objects.create(
            tenantname="Test Tenant", subdomain_prefix="test"
        )
