...
class TestJobViews:
    ...
    def test_get_scheduled_internal_tours(self, authenticated_job_request, job_factory):
        ...
        internal_tours = Job.objects.filter(
            identifier="INTERNALTOUR", enable=True, client=bt
        )
    ...
    def test_jobneed_creation_and_details(self, jobneed_factory):
        ...
        jobneed = jobneed_factory(
            jobdesc="Security Check", priority="HIGH", gracetime=10
        )
    ...
    def test_job_priority_validation(self, client_bt, bu_bt, priority, expected_valid):
        ...
        # Create required shift
        shift = Shift.objects.create(
            shiftname=f"Test Shift {priority}", starttime="09:00", endtime="17:00"
        )
    ...
    def test_jobneed_details_answertype_validation(
        self, jobneed_factory, answer_type, expected_valid
    ):
    ...
    def test_job_date_constraints(self, client_bt, bu_bt):
        ...
        shift = Shift.objects.create(
            shiftname="Date Test Shift", starttime="09:00", endtime="17:00"
        )
    ...
    def test_jobneed_details_decimal_precision(self, jobneed_factory):
        ...
        details = JobneedDetails.objects.create(
            jobneed=jobneed, seqno=1, min=1.2345, max=99.9876, answertype="NUMERIC"
        )
    ...
    def test_job_identifier_choices(self, client_bt, bu_bt):
        ...
        shift = Shift.objects.create(
            shiftname="Identifier Test Shift", starttime="09:00", endtime="17:00"
        )
        future_date = timezone.now() + timedelta(days=1)
