...
class Jobneed(BaseModel, TenantAwareModel):
    ...
    remarkstype = models.ForeignKey("core_onboarding.TypeAssist", on_delete=models.RESTRICT, null=True, blank=True, related_name="remark_types")
    ...
    client = models.ForeignKey("client_onboarding.Bt", verbose_name=_("Client"), on_delete=models.RESTRICT, null=True, blank=True, related_name="jobneed_clients")
    bu = models.ForeignKey("client_onboarding.Bt", verbose_name=_("Site"), on_delete=models.RESTRICT, null=True, blank=True, related_name="jobneedf_bus")
    ticketcategory = models.ForeignKey("core_onboarding.TypeAssist", verbose_name=_("Notify Category"), null=True, blank=True, on_delete=models.RESTRICT)
