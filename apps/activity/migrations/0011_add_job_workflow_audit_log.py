    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='%(class)s_bus', to='client_onboarding.bt')),
                ...
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='%(class)s_clients', to='client_onboarding.bt')),
