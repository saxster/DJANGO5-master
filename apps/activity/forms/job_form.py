...
class JobForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "jobdesc": forms.Textarea(
                attrs={"rows": "5", "placeholder": "What does this tour about?"}
            ),
        }
    ...
    class Meta:
        ...
        widgets = {
            ...
            "qset": s2forms.ModelSelect2Widget(
                model=QuestionSet, search_fields=["qset_name__icontains"]
            ),
            "asset": s2forms.ModelSelect2Widget(
                model=Asset, search_fields=["assetname__icontains"]
            ),
            "priority": s2forms.Select2Widget(attrs={"data-theme": "bootstrap5"}),
        ...
        label = {"endtime": "End Time", "ticketcategory": "Notify Category"}
...
class PPMFormJobneed(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["asset"].queryset = Asset.objects.filter_for_dd_asset_field(
            self.request, ["ASSET"], sitewise=True
        )
        initailize_form_fields(self)
