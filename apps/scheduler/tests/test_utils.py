...
@pytest.mark.skip(reason="Tests refer to non-existent function: filter_jobs")
...
@pytest.mark.skip(reason="Tests refer to non-existent function: process_job")
...
class GetDatetimeListTestCase(TestCase):
    ...
    def test_get_datetime_list_valid_cron(self, mock_croniter_class):
        ...
        dt_list, is_valid, resp = sutils.get_datetime_list(
            "0 8 * * *", start_dt, end_dt, {}
        )
...
@pytest.mark.skip(reason="Tests refer to non-existent utils.Asset")
