...
class JinjaEnvironment(Environment):
    ...
    def _finalize_output(self, obj):
        """Automatically convert Django form fields to strings for rendering"""
        ...
        if isinstance(obj, BoundField):
            ...
            # Support objects with __html__ method (Django forms, widgets, etc.)
    ...
    def __init__(self, **kwargs):
        ...
        # Auto-render Django form fields and widgets
        self.finalize = self._finalize_output
